...
function Config.Setup(raw)
    ...
    CSP_SHOW_VIEWPORT_BORDER = d.show_viewport_border == true
    CSP_DEBUG_LOGGING = d.enable_debug_logging == true
    CSP_MAX_RENDER_COMBOS = d.max_render_combos
    return d
end
